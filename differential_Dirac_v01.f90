...
do f=1,num_faces
  do i=1,links_in_f(f)%num_
    ...
    do j=1,links_in_f(f)%num_
      ...
      !call calc_diffdiff_Omega(diffdiff_Omega,Uf(:,:,f),Ufm(:,:,f),f,l,ll,UMAT)
      ! checked: diffdiff_Omega is hermitian
     ...
     !     do jj=1,NMAT
     !       do b=1,dimG
     !         write(*,*) f, ii,jj,b,c,j,i, &
     !           diffdiff_Omega(ii,jj,b,c)-diffdiff_Omega2(f)%val(ii,jj,b,c,i,j)
     !       enddo
     !     enddo
     !   enddo
       enddo
...
do l=1,num_links
  do i=1,face_in_l(l)%num_
    ...
    do j=1,links_in_f(f)%num_
      ...
      !call calc_diffdiff_Omega(diffdiff_Omega,Uf(:,:,f),Ufm(:,:,f),f,ll,l,UMAT)
        ...
        do b=1,dimG
          ...
          do ii=1,NMAT
            do jj=1,NMAT
              ...
              !write(*,*) jj,ii,b,a,j,i,f,&
              !  diffdiff_Omega(jj,ii,b,a)-diffdiff_Omega2(f)%val(jj,ii,b,a,j,k)
            enddo
          enddo
