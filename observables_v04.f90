...
obs = obs * (0.25d0,0d0) * cmplx(overall_factor*overall_factor * mass_square_phi)
...
obs = obs * (0d0,-1d0) * cmplx(overall_factor*overall_factor * mass_square_phi )
...
obs = obs * (0d0,-0.5d0) * cmplx(overall_factor*overall_factor * mass_square_phi)
