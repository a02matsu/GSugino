...
call calc_opL1_2(opL1, PhiMat, Umat, Geta_lambda, Glambda_lambda, phibar_p, ratio)
call calc_opL2_2(opL2, PhiMat, Umat, Geta_lambda, Glambda_lambda, phibar_p, ratio)
