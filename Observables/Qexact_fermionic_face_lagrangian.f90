...
!! Namely,
!!   Lff ~ +2i \chi \lambda
subroutine Qexact_fermionic_face_lagrangian_adm(Lff,lf,l_place,Glambda_chi,Umat)
...
Lff = Lff * (0d0,1d0)*U1Rfactor_fl


end subroutine Qexact_fermionic_face_lagrangian_adm

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! SF^f = 1/2g^2 \sum_f \sum_{l\in Lf} \alpha_f\beta_f\epsilon_{l,f) Lff(f,l)
subroutine Qexact_fermionic_face_lagrangian(Lff,lf,l_place,Glambda_chi,Umat)
use global_parameters
...
end subroutine Qexact_fermionic_face_lagrangian


!!!!!!!!!!!!
!! Lff  = Lff + Tr( lambda.Mat1.chi.Mat2 )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! SF^f = 1/2g^2 \sum_f \sum_{l\in Lf} \alpha_f\beta_f \epsilon_{l,f) Lff(f,l)
subroutine Qexact_fermionic_face_lagrangian_m0(Lff,lf,l_place,Glambda_chi,Umat)
use global_parameters
use matrix_functions, only : matrix_product,Hermitian_conjugate,matrix_power,matrix_inverse
implicit none
...
Lff=(0d0,0d0)
  ...
  !! term 2
  call Hermitian_conjugate(Mat1, Xmat)
  call Hermitian_conjugate(Mat2, Ymat)
  call update_Lff(Lff, Glambda_chi, gl, lf, Mat1, Mat2)

Lff = Lff * (0d0,-1d0) * U1Rfactor_fl


end subroutine Qexact_fermionic_face_lagrangian_m0
