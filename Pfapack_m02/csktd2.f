...
*  =======
*
*  CSKTD2 reduces a complex skew-symmetric matrix A to real skew-symmetric
...
*  ===============
*
*  The normal use for CSKTD2 is to compute the tridiagonal form of
*  a skew-symmetric matrix under an orthogonal similarity transformation,
*  and chosen by setting MODE = 'N' ("normal" mode). The other
*  use of CSKTD2 is the computation the Pfaffian of a skew-symmetric matrix,
...
*  or in the even columns (if UPLU = 'U') are properly computed by CSKTD2.
*
...
*  element not computed by CSKTD2.
*
*  =====================================================================
*
*     .. Parameters ..
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, CSKMV, CSKR2, CLARFG
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*
 ...
 12            CONTINUE
*
               CALL CSKMV( UPLO, I, CONJG(TAUI), A, LDA,
...
*                 A := A + v * w^T - w * v^T
*
               CALL CSKR2( UPLO, I-STEP+1, ONE, A( 1, I+1 ), 1, TAU, 1,
     $                     A, LDA )
*
            ELSE
               A( I, I ) = ZERO
...
*
   ...
   30          CONTINUE
               ...
               CALL CSKMV( UPLO, N-I, CONJG(TAUI), A( I+1, I+1 ), LDA,
...
*
               IF( I.LT.N-1 ) THEN
                  CALL CSKR2( UPLO, N-I-STEP+1, ONE, A( I+STEP, I ), 1,
     $                        TAU( I+STEP-1 ), 1,
     $                        A( I+STEP, I+STEP ), LDA )
               END IF
*
