...
complex(kind(0d0)), allocatable, save :: global_U1Rfactor(:) ! U(1)_R mass in the continuum ( \omega_l. )
complex(kind(0d0)), allocatable, save :: global_site_U1Rfactor(:) ! U(1)_R factor on site: exp(i \gamma_s)
...
!complex(kind(0d0)), allocatable, save :: site_U1Rfactor(:)  ! U(1)_R facotor on site
