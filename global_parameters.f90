...
!integer, parameter :: p5_test=0 ! set 1 in testing the balance of hamiltonian and force.
...
double precision :: bosonic_force_Phi
double precision :: fermionic_force_Phi
double precision :: bosonic_force_A
double precision :: fermionic_force_A
integer :: b_phi_count, f_phi_count, b_A_count, f_A_count
...
integer :: force_measurement !!  0:measure forces
...
!integer :: Ntau 
double precision:: Tau ! trajectory length
double precision :: Dtau,Dtau_phi,Dtau_A   ! Dtau
integer :: Ntau

! For multi-step
integer :: FB_ratio ! Phiのfermion forceの計算回数をboson forceの回数の何倍にするか
integer :: Nfermion, Nboson
double precision :: Dtau_boson ! Dtau for boson
double precision :: Dtau_fermion ! Dtau for fermion
...
! For multi-step
!integer :: FBphi_ratio ! Phiのfermion forceの計算回数をboson forceの回数の何倍にするか
!integer :: FBA_ratio ! Aのfermion forceの計算回数をboson forceの回数の何倍にするか
!integer :: Nfermion_phi, Nboson_phi
!integer :: Nfermion_A, Nboson_A
!double precision :: Dtau_phi_boson ! Dtau for Phi
!double precision :: Dtau_phi_fermion ! Dtau for Phi
!double precision :: Dtau_A_boson   ! Dtau for A
!double precision :: Dtau_A_fermion   ! Dtau for A
...
call MPI_BCAST(Nfermion,1,MPI_INTEGER,0,MPI_COMM_WORLD,IERR)
call MPI_BCAST(Nboson,1,MPI_INTEGER,0,MPI_COMM_WORLD,IERR)
call MPI_BCAST(Dtau_boson,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
call MPI_BCAST(Dtau_fermion,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
