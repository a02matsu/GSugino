...
integer, allocatable :: direct_index(:)
integer :: org, tip, s1, s2
...
allocate( direct_index(1:num_sites) )
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!! set index of sites
s=0
do n=1,sizeN/2
  do m=1, sizeM
    s=s+1
    direct_index(s)=mod( mod(m,2) + mod(n,2), 2 )
    !write(*,*) s, direct_index(s)
  enddo
enddo
...
do n=1,sizeN/2
  do i=1,sizeM-1
    ...
    write(OUT,'(I6,X,I6,X,I6,X,E15.8,X,A)') l, org, tip, alpha_l(l), "0d0"
